...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap= "Census Data Visualization 1"}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap= "Census Data Visualization 2"}
...
```{r, echo=FALSE, message=FALSE, fig.cap= "Survey Data Visualization (partial)"}
#make plot for the ages (group)
